...
div session.scrap_listHouses ul li {
	margin: auto;
	list-style: none;
	display: inline-block;
}

div session.scrap_listHouses img {
	width: 280px;
	height: 280px;
	padding:10px 0 0 0 ;
}
...
<body class="scrap_houses">
	...
	<div>
		<session class="scrap_listHouses">
		<ul>
			<li><a href="#"><img
					src="http://localhost:9000/myhouse/images/1.webp"></a>
			</li>
			<li><a href="#"><img
